...
const AboutUs = () => {
  ...
  return (
    <>
      ...
      <section id="about" className="mx-5 md:container md:mx-auto pb-20">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="accordion mt-10">
              ...
              <div className="accordion-item">
                ...
                <div className={`accordion-content p-4 ${isToggled2 ? "hidden" : ""
                  }`}>
                  <p className="text-justify">
              ...
              <div className="accordion-item">
                ...
                <div className={`accordion-content p-4 ${isToggled3 ? "hidden" : ""
                  }`}>
                  <p className="text-justify">
